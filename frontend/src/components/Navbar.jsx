...
const Navbar = () => {
    ...
    return (
        <div className="flex items-center justify-between px-6 py-3 bg-white-100 shadow-md w-full max-w-screen-xl mx-auto">
            {/* Logo */}
            <div className="flex items-center space-x-3">
                <img
                    ...
                    src={cureTimeImage}
                    alt="CureTime Logo"
                    className="h-16 w-auto cursor-pointer object-contain rounded-sm"
                />
